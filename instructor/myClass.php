  ...
  <div class="container bg-white">
    ...
    <div class="pb-5">
      ...
      <div class="row bg-light d-flex pb-3 shadow-sm rounded">
        <?php 
          $sql = "SELECT cms_classrooms.classroom_id, cms_classrooms.subject_code, cms_classrooms.sections, cms_classes.class_code, cms_classes.subject, cms_classrooms.created_at FROM `cms_classrooms` INNER JOIN cms_classes ON cms_classrooms.class_id=cms_classes.class_id WHERE cms_classrooms.school_id='$school_id';";
