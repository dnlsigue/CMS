...
if (!$id || !$school_id1 || !$first_name1 || !$last_name1)
  echo '<script>alert("Invalid Parameter"); window.location.href="coordinatorManage.php"</script>';
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <form method="post" class="bg-light border border-primary rounded p-5">
            ...
            <!-- ADD STUDENT MODAL -->
            <h1 class="text-center fw-bold mb-5">Edit COORDINATOR</h1>
            ...
            <div class="d-flex justify-content-around mt-4">
              ...
              <a href="coordinatorManage.php"><input type="button" class="btn btn-danger btn-lg mx-2" value="Close"></input></a>
            </div>
          ...
          if (isset($_POST['submitEdit'])) {
            ...
            $res = $con->query(
              "UPDATE cms_coordinators SET 
              school_id='$school_id2', 
              first_name='$first_name', 
              last_name='$last_name'
              WHERE id='$id'"
            );
            echo '<script>window.location.href="coordinatorManage.php"</script>';
          }
          ?>
        </div>
      </div>
