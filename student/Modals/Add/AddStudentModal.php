...
if (isset($_POST['addingStudentSubmit'])) {
  ...
  $checkSchoolID = mysqli_query($con, "SELECT *  FROM cms_students where school_id = '$school_id' ");
...
<?php
    ...
    $res = $con->query("INSERT INTO `cms_students`(`school_id`, `first_name`, `last_name`, `section`, `status`) 
