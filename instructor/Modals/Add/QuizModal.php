  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" class="bg-light border border-primary rounded p-5" enctype="multipart/form-data">
        ...
        <!-- CREATE CLASS MODAL -->
        <h1 class="text-center fw-bold mb-5">Create Quiz</h1>
        ...
        <div class="d-flex justify-content-around mt-4">
          <input type="submit" class="btn btn-success btn-lg" name="addQuiz" value="Add"></input>
...
if (isset($_POST['addQuiz'])) {
  ...
  if(isset($_FILES['file'])){
    ...
    $targetDirectory = "../uploads/instructor_quizzes/";

    // Generate a unique name for the file to avoid conflicts
    $fileName = 'quiz_' . uniqid() . '_' . $uploadedFile['name'];
    ...
    if (in_array($fileExtension, $allowedExtensions)) {
      ...
      if (move_uploaded_file($uploadedFile['tmp_name'], $targetPath)) {
        ...
        $sql = "INSERT INTO cms_instructors_topics_quizzes (instructors_topics_id, quiz_submission_start, quiz_submission_deadline, quiz_file_path, quiz_name, quiz_description, quiz_allow_submission, quiz_items) ". 
        "VALUES (?, ?, ?, ?, ?, ?, ?, 100)";
