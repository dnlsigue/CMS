...
<script>
  $(document).ready(function() {
    var table = $('#instructorView ').DataTable({
      ...
      "processing": true,
      "ajax": "./coordinator_script/instructor_data.php",
      "columns": [{
          data: 'id'
        },
        {
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return '<div class="d-grid gap-2 d-sm-block justify-content-sm-center"><a href="coordinator_components/action.php?role=instructor&action=edit&id=' + data + '"><button type="submit" class="btn btn-outline-primary mx-1">Edit<i class="fa-solid fa-pen-to-square h5"></i></button></a><a href="coordinator_components/action.php?role=instructor&action=delete&id=' + data + '" class="text-white text-decoration-none"><button type="submit" class="btn btn-outline-danger mx-1 ">Delete<i class="fa fa-trash h5" aria-hidden="true"></i></button></a></div>'
          }
        }
      ],
      columnDefs: [{
