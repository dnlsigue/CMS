  ...
  <div class="container pt-4">
    <div class="container-lg p-1 bg-white rounded">
      ...
      <div class="container text-start pd-5" id="student_wrapper">
        <table id="studentView" class=" table-bordered display responsive compact table table-striped text-center text-nowrap" width="100%  ">
          <thead>
            <tr>
      ...
      "columns": [{
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return '<div class="d-grid gap-2 d-sm-block justify-content-sm-center"><a href="admin_components/action.php?role=student&action=edit&id=' + data + '"><button type="submit" class="btn btn-outline-primary mx-1">Edit<i class="fa-solid fa-pen-to-square h5"></i></button></a><a href="admin_components/action.php?role=student&action=delete&id=' + data + '" class="text-white text-decoration-none"><button type="submit" class="btn btn-outline-danger mx-1 ">Delete<i class="fa fa-trash h5" aria-hidden="true"></i></button></a></div>'
          }
        }
      ],
      columnDefs: [{
